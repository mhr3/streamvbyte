...
LBB0_7:
	...
	WORD $0xb800452b       // MOVW.P R11, 4(R9)                    // str	w11, [x9], #4
...
LBB2_4:
	...
	SUBS $8, R11, R11           // <--                                  // subs	x11, x11, #8
	ADD  $32, R9, R9            // <--                                  // add	x9, x9, #32
	VAND V0.B16, V1.B16, V3.B16 // <--                                  // and	v3.16b, v1.16b, v0.16b
	VAND V0.B16, V2.B16, V4.B16 // <--                                  // and	v4.16b, v2.16b, v0.16b
	WORD $0x6f3f0421            // VUSHR $1, V1.S4, V1.S4               // ushr	v1.4s, v1.4s, #1
	WORD $0x6f3f0442            // VUSHR $1, V2.S4, V2.S4               // ushr	v2.4s, v2.4s, #1
	WORD $0x6ea0b863            // VNEG V3.S4, V3.S4                    // neg	v3.4s, v3.4s
	WORD $0x6ea0b884            // VNEG V4.S4, V4.S4                    // neg	v4.4s, v4.4s
	VEOR V3.B16, V1.B16, V1.B16 // <--                                  // eor	v1.16b, v1.16b, v3.16b
	VEOR V4.B16, V2.B16, V2.B16 // <--                                  // eor	v2.16b, v2.16b, v4.16b

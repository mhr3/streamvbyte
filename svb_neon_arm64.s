...
LBB6_3:
	...
	WORD $0x3dc001a3                   // FMOVQ (R13), F3                      // ldr	q3, [x13, :lo12:.LCPI6_0]
...
LBB6_5:
	...
	WORD  $0x2f0c04c5            // VUSHR $4, V6.B8, V5.B8               // ushr	v5.8b, v6.8b, #4
	VAND  V0.B8, V6.B8, V6.B8    // <--                                  // and	v6.8b, v6.8b, v0.8b
	BEQ   LBB6_7                 // <--                                  // b.eq	.LBB6_7
	VTBL  V6.B8, [V3.B16], V6.B8 // <--                                  // tbl	v6.8b, { v3.16b }, v6.8b
	VTBL  V5.B8, [V3.B16], V5.B8 // <--                                  // tbl	v5.8b, { v3.16b }, v5.8b
...
LBB6_8:
	...
	VEXT  $12, V6.B16, V1.B16, V7.B16 // <--                                  // ext	v7.16b, v1.16b, v6.16b, #12
	VADD  V6.S4, V7.S4, V6.S4         // <--                                  // add	v6.4s, v7.4s, v6.4s
	VEXT  $8, V6.B16, V1.B16, V7.B16  // <--                                  // ext	v7.16b, v1.16b, v6.16b, #8

...
LBB2_3:
	...
	AND  $-16, R1, R11                 // <--                                  // and	x11, x1, #0xfffffffffffffff0
	...
	NOP                                // (skipped)                            // add	x13, x13, :lo12:shuffleTable_0124
...
LBB2_17:
	...
	BGT  LBB2_20       // <--                                  // b.gt	.LBB2_20
	CBZW R13, LBB2_14  // <--                                  // cbz	w13, .LBB2_14
...
LBB2_26:
	...
	ANDW $3, R13, R13  // <--                                  // and	w13, w13, #0x3
	CMPW $1, R13       // <--                                  // cmp	w13, #1
	BGT  LBB2_29       // <--                                  // b.gt	.LBB2_29
	CBZW R13, LBB2_22  // <--                                  // cbz	w13, .LBB2_22
...
LBB2_33:
	...
	NOP                                // (skipped)                            // add	x12, x12, :lo12:lengthTable_1234
	MOVD $shuffleTable_1234<>(SB), R13 // <--                                  // adrp	x13, shuffleTable_1234
	NOP                                // (skipped)                            // add	x13, x13, :lo12:shuffleTable_1234
	MOVD R4, R9                        // <--                                  // mov	x9, x4
...
LBB3_10:
	CBZ  R8, LBB3_32  // <--                                  // cbz	x8, .LBB3_32
	SUB  R4, R9, R10  // <--                                  // sub	x10, x9, x4
	LSR  $2, R10, R10 // <--                                  // lsr	x10, x10, #2
	SUBW R10, R3, R10 // <--                                  // sub	w10, w3, w10
	CBZW R10, LBB3_32 // <--                                  // cbz	w10, .LBB3_32
	WORD $0x3840140b  // MOVBU.P 1(R0), R11                   // ldrb	w11, [x0], #1
	TSTW $255, R5     // <--                                  // tst	w5, #0xff
	MOVW ZR, R12      // <--                                  // mov	w12, wzr
...
LBB3_17:
	...
	ANDW $3, R13, R13  // <--                                  // and	w13, w13, #0x3
	CMPW $1, R13       // <--                                  // cmp	w13, #1
	BGT  LBB3_20       // <--                                  // b.gt	.LBB3_20
	CBZW R13, LBB3_14  // <--                                  // cbz	w13, .LBB3_14
	WORD $0x3840150d   // MOVBU.P 1(R8), R13                   // ldrb	w13, [x8], #1
...
LBB3_26:
	...
	ANDW $3, R13, R13  // <--                                  // and	w13, w13, #0x3
	CMPW $1, R13       // <--                                  // cmp	w13, #1
	BGT  LBB3_29       // <--                                  // b.gt	.LBB3_29
	CBZW R13, LBB3_22  // <--                                  // cbz	w13, .LBB3_22
	WORD $0x7940010d   // MOVHU (R8), R13                      // ldrh	w13, [x8]
	MOVW $2, R14       // <--                                  // mov	w14, #2
...
DATA LCPI6_1<>+0x00(SB)/8, $0x0605040305040302
DATA LCPI6_1<>+0x08(SB)/8, $0x0807060507060504
...
LBB6_3:
	NOP                                // (skipped)                            // stp	x29, x30, [sp, #-16]!
	ADD  R3>>2, R0, R9                 // <--                                  // add	x9, x0, x3, lsr #2
	NOP                                // (skipped)                            // mov	x29, sp
	SUB  $7, R9, R10                   // <--                                  // sub	x10, x9, #7
	...
	NOP                                // (skipped)                            // add	x12, x12, :lo12:shuffleTable_1234
...
LBB6_5:
	VTBL  V5.B8, [V2.B16], V5.B8 // <--                                  // tbl	v5.8b, { v2.16b }, v5.8b
	VTBL  V4.B8, [V2.B16], V4.B8 // <--                                  // tbl	v4.8b, { v2.16b }, v4.8b
	VADD  V5.B8, V4.B8, V4.B8    // <--                                  // add	v4.8b, v4.8b, v5.8b
	WORD  $0x0e31b885            // VADDV V4.B8, V5                      // addv	b5, v4.8b
	FMOVS F5, R16                // <--                                  // fmov	w16, s5
	ADD   R16, R9, R16           // <--                                  // add	x16, x9, x16
	CMP   R11, R16               // <--                                  // cmp	x16, x11
	MOVD  R12, R16               // <--                                  // mov	x16, x12
	BHI   LBB6_9                 // <--                                  // b.hi	.LBB6_9

LBB6_6:
	AND   $255, R15, R17              // <--                                  // and	x17, x15, #0xff
	WORD  $0x3dc00125                 // FMOVQ (R9), F5                       // ldr	q5, [x9]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3cf17a06                 // FMOVQ (R16)(R17<<4), F6              // ldr	q6, [x16, x17, lsl #4]
	FMOVD F4, R17                     // <--                                  // fmov	x17, d4
	ADD   $8, R0, R0                  // <--                                  // add	x0, x0, #8
	CMP   R10, R0                     // <--                                  // cmp	x0, x10
	VTBL  V6.B16, [V5.B16], V5.B16    // <--                                  // tbl	v5.16b, { v5.16b }, v6.16b
	LSR   $8, R17, R1                 // <--                                  // lsr	x1, x17, #8
	ADD   R1.UXTB, R9, R9             // <--                                  // add	x9, x9, w1, uxtb
	UBFX  $8, R15, $8, R1             // <--                                  // ubfx	x1, x15, #8, #8
	VEXT  $12, V5.B16, V1.B16, V6.B16 // <--                                  // ext	v6.16b, v1.16b, v5.16b, #12
	VADD  V5.S4, V6.S4, V5.S4         // <--                                  // add	v5.4s, v6.4s, v5.4s
	VEXT  $8, V5.B16, V1.B16, V6.B16  // <--                                  // ext	v6.16b, v1.16b, v5.16b, #8
	VADD  V3.S4, V5.S4, V3.S4         // <--                                  // add	v3.4s, v5.4s, v3.4s
	VADD  V6.S4, V3.S4, V3.S4         // <--                                  // add	v3.4s, v3.4s, v6.4s
	WORD  $0x3d800103                 // FMOVQ F3, (R8)                       // str	q3, [x8]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3ce17a05                 // FMOVQ (R16)(R1<<4), F5               // ldr	q5, [x16, x1, lsl #4]
	LSR   $16, R17, R1                // <--                                  // lsr	x1, x17, #16
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	ADD   R1.UXTB, R9, R9             // <--                                  // add	x9, x9, w1, uxtb
	UBFX  $16, R15, $8, R1            // <--                                  // ubfx	x1, x15, #16, #8
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	VADD  V5.S4, V3.S4, V3.S4         // <--                                  // add	v3.4s, v3.4s, v5.4s
	WORD  $0x3d800503                 // FMOVQ F3, 16(R8)                     // str	q3, [x8, #16]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3ce17a05                 // FMOVQ (R16)(R1<<4), F5               // ldr	q5, [x16, x1, lsl #4]
	LSR   $24, R17, R1                // <--                                  // lsr	x1, x17, #24
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	ADD   R1.UXTB, R9, R9             // <--                                  // add	x9, x9, w1, uxtb
	UBFX  $24, R15, $8, R1            // <--                                  // ubfx	x1, x15, #24, #8
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V5.S4, V4.S4, V4.S4         // <--                                  // add	v4.4s, v4.4s, v5.4s
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	WORD  $0x3d800903                 // FMOVQ F3, 32(R8)                     // str	q3, [x8, #32]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3ce17a05                 // FMOVQ (R16)(R1<<4), F5               // ldr	q5, [x16, x1, lsl #4]
	LSR   $32, R17, R1                // <--                                  // lsr	x1, x17, #32
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	ADD   R1.UXTB, R9, R9             // <--                                  // add	x9, x9, w1, uxtb
	UBFX  $32, R15, $8, R1            // <--                                  // ubfx	x1, x15, #32, #8
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V5.S4, V4.S4, V4.S4         // <--                                  // add	v4.4s, v4.4s, v5.4s
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	WORD  $0x3d800d03                 // FMOVQ F3, 48(R8)                     // str	q3, [x8, #48]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3ce17a05                 // FMOVQ (R16)(R1<<4), F5               // ldr	q5, [x16, x1, lsl #4]
	LSR   $40, R17, R1                // <--                                  // lsr	x1, x17, #40
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	ADD   R1.UXTB, R9, R9             // <--                                  // add	x9, x9, w1, uxtb
	UBFX  $40, R15, $8, R1            // <--                                  // ubfx	x1, x15, #40, #8
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V5.S4, V4.S4, V4.S4         // <--                                  // add	v4.4s, v4.4s, v5.4s
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	WORD  $0x3d801103                 // FMOVQ F3, 64(R8)                     // str	q3, [x8, #64]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3ce17a05                 // FMOVQ (R16)(R1<<4), F5               // ldr	q5, [x16, x1, lsl #4]
	LSR   $48, R17, R1                // <--                                  // lsr	x1, x17, #48
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	ADD   R1.UXTB, R9, R9             // <--                                  // add	x9, x9, w1, uxtb
	UBFX  $48, R15, $8, R1            // <--                                  // ubfx	x1, x15, #48, #8
	LSR   $52, R15, R15               // <--                                  // lsr	x15, x15, #52
	AND   $4080, R15, R15             // <--                                  // and	x15, x15, #0xff0
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V5.S4, V4.S4, V4.S4         // <--                                  // add	v4.4s, v4.4s, v5.4s
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	WORD  $0x3d801503                 // FMOVQ F3, 80(R8)                     // str	q3, [x8, #80]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3ce17a05                 // FMOVQ (R16)(R1<<4), F5               // ldr	q5, [x16, x1, lsl #4]
	ADD   R17>>56, R9, R9             // <--                                  // add	x9, x9, x17, lsr #56
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V5.S4, V4.S4, V4.S4         // <--                                  // add	v4.4s, v4.4s, v5.4s
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	WORD  $0x3d801903                 // FMOVQ F3, 96(R8)                     // str	q3, [x8, #96]
	VDUP  V3.S[3], V3.S4              // <--                                  // dup	v3.4s, v3.s[3]
	WORD  $0x3dc00124                 // FMOVQ (R9), F4                       // ldr	q4, [x9]
	WORD  $0x3cef6a05                 // FMOVQ (R16)(R15), F5                 // ldr	q5, [x16, x15]
	VTBL  V5.B16, [V4.B16], V4.B16    // <--                                  // tbl	v4.16b, { v4.16b }, v5.16b
	VEXT  $12, V4.B16, V1.B16, V5.B16 // <--                                  // ext	v5.16b, v1.16b, v4.16b, #12
	VADD  V4.S4, V5.S4, V4.S4         // <--                                  // add	v4.4s, v5.4s, v4.4s
	VEXT  $8, V4.B16, V1.B16, V5.B16  // <--                                  // ext	v5.16b, v1.16b, v4.16b, #8
	VADD  V5.S4, V4.S4, V4.S4         // <--                                  // add	v4.4s, v4.4s, v5.4s
	VADD  V3.S4, V4.S4, V3.S4         // <--                                  // add	v3.4s, v4.4s, v3.4s
	WORD  $0x3d801d03                 // FMOVQ F3, 112(R8)                    // str	q3, [x8, #112]
	ADD   $128, R8, R8                // <--                                  // add	x8, x8, #128
	BCS   LBB6_9                      // <--                                  // b.hs	.LBB6_9

LBB6_7:
	WORD  $0xf940000f            // MOVD (R0), R15                       // ldr	x15, [x0]
	TSTW  $255, R6               // <--                                  // tst	w6, #0xff
	FMOVD R15, F4                // <--                                  // fmov	d4, x15
	VAND  V0.B8, V4.B8, V5.B8    // <--                                  // and	v5.8b, v4.8b, v0.8b
	WORD  $0x2f0c0484            // VUSHR $4, V4.B8, V4.B8               // ushr	v4.8b, v4.8b, #4
	BEQ   LBB6_5                 // <--                                  // b.eq	.LBB6_5
	WORD  $0x3dc001a6            // FMOVQ (R13), F6                      // ldr	q6, [x13, :lo12:.LCPI6_0]
	VTBL  V5.B8, [V6.B16], V5.B8 // <--                                  // tbl	v5.8b, { v6.16b }, v5.8b
	VTBL  V4.B8, [V6.B16], V4.B8 // <--                                  // tbl	v4.8b, { v6.16b }, v4.8b
	VADD  V5.B8, V4.B8, V4.B8    // <--                                  // add	v4.8b, v4.8b, v5.8b
	WORD  $0x0e31b885            // VADDV V4.B8, V5                      // addv	b5, v4.8b
	FMOVS F5, R16                // <--                                  // fmov	w16, s5
	ADD   R16, R9, R16           // <--                                  // add	x16, x9, x16
...
LBB6_13:
	CBZ  R9, LBB6_35 // <--                                  // cbz	x9, .LBB6_35
	CBZW R3, LBB6_35 // <--                                  // cbz	w3, .LBB6_35
	WORD $0x3840140a // MOVBU.P 1(R0), R10                   // ldrb	w10, [x0], #1
	TSTW $255, R6    // <--                                  // tst	w6, #0xff
	MOVW ZR, R11     // <--                                  // mov	w11, wzr
	BNE  LBB6_18     // <--                                  // b.ne	.LBB6_18
	JMP  LBB6_27     // <--                                  // b	.LBB6_27
...
LBB6_29:
	...
	ANDW $3, R12, R12  // <--                                  // and	w12, w12, #0x3
	CMPW $1, R12       // <--                                  // cmp	w12, #1
	BGT  LBB6_32       // <--                                  // b.gt	.LBB6_32
	CBZW R12, LBB6_25  // <--                                  // cbz	w12, .LBB6_25
...
LBB7_3:
	...
	NOP                                // (skipped)                            // add	x8, x8, :lo12:lengthTable_0124
	...
	CSEL EQ, R14, R13, R13             // <--                                  // csel	x13, x14, x13, eq
	MOVD R5, R8                        // <--                                  // mov	x8, x5
...
LBB7_6:
	...
	WORD $0x3cef79a4                 // FMOVQ (R13)(R15<<4), F4              // ldr	q4, [x13, x15, lsl #4]
...
LBB7_12:
	CBZ  R9, LBB7_34 // <--                                  // cbz	x9, .LBB7_34
	CBZW R3, LBB7_34 // <--                                  // cbz	w3, .LBB7_34
	WORD $0x3840140a // MOVBU.P 1(R0), R10                   // ldrb	w10, [x0], #1
	TSTW $255, R6    // <--                                  // tst	w6, #0xff
	MOVW ZR, R11     // <--                                  // mov	w11, wzr
...
LBB7_19:
	...
	ANDW $3, R12, R12  // <--                                  // and	w12, w12, #0x3
	CMPW $1, R12       // <--                                  // cmp	w12, #1
	BGT  LBB7_22       // <--                                  // b.gt	.LBB7_22
	CBZW R12, LBB7_16  // <--                                  // cbz	w12, .LBB7_16
	WORD $0x3840152c   // MOVBU.P 1(R9), R12                   // ldrb	w12, [x9], #1
...
LBB7_28:
	...
	ANDW $3, R12, R12  // <--                                  // and	w12, w12, #0x3
	CMPW $1, R12       // <--                                  // cmp	w12, #1
	BGT  LBB7_31       // <--                                  // b.gt	.LBB7_31
	CBZW R12, LBB7_24  // <--                                  // cbz	w12, .LBB7_24
	WORD $0x7940012c   // MOVHU (R9), R12                      // ldrh	w12, [x9]
	MOVW $2, R13       // <--                                  // mov	w13, #2

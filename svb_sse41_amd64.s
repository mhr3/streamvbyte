...
LBB1_2:
	LONG $0x03c6f640               // TESTB $0x3, SI                       // test	sil, 3
...
TEXT ·svb_decode_u32_std(SB), NOSPLIT, $0-48
	...
	JLE  LBB4_2              // <--                                  // jle	.LBB4_2
	LEAQ 0x3(CX), DX         // <--                                  // lea	rdx, [rcx + 3]
	SHRQ $0x2, DX            // <--                                  // shr	rdx, 2
	CMPQ DX, SI              // <--                                  // cmp	rdx, rsi
	JBE  LBB4_3              // <--                                  // jbe	.LBB4_3
...
LBB4_3:
	...
	LEAQ -0x10(DI)(SI*1), AX          // <--                                  // lea	rax, [rdi + rsi - 16]
	LONG $0xc7420f48                  // CMOVB DI, AX                         // cmovb	rax, rdi
	CMPQ CX, $0x4                     // <--                                  // cmp	rcx, 4
	LONG $0xc1930f41                  // SETAE R9                             // setae	r9b
	CMPQ DX, AX                       // <--                                  // cmp	rdx, rax
	LONG $0xc2960f41                  // SETBE R10                            // setbe	r10b
	WORD $0x2045; BYTE $0xca          // ANDL R9, R10                         // and	r10b, r9b
	CMPB R10, $0x1                    // <--                                  // cmp	r10b, 1
	JNE  LBB4_7                       // <--                                  // jne	.LBB4_7
	MOVQ CX, R11                      // <--                                  // mov	r11, rcx
	SHRQ $0x2, R11                    // <--                                  // shr	r11, 2
	ADDQ DI, R11                      // <--                                  // add	r11, rdi
...
LBB4_5:
	MOVQ DX, R15                               // <--                                  // mov	r15, rdx
	LONG $0x22b60f45                           // MOVZX 0(R10), R12                    // movzx	r12d, byte ptr [r10]
	LONG $0x14b60f41; BYTE $0x1c               // MOVZX 0(R12)(BX*1), DX               // movzx	edx, byte ptr [r12 + rbx]
	LONG $0x6f0f41f3; BYTE $0x07               // MOVDQU 0(R15), X0                    // movdqu	xmm0, xmmword ptr [r15]
	LONG $0x04e4c141                           // SHLL $0x4, R12                       // shl	r12d, 4
	LONG $0x380f4366; WORD $0x0400; BYTE $0x34 // PSHUFB 0(R12)(R14*1), X0             // pshufb	xmm0, xmmword ptr [r12 + r14]
	ADDQ R15, DX                               // <--                                  // add	rdx, r15
	LONG $0x7f0f41f3; BYTE $0x01               // MOVDQU X0, 0(R9)                     // movdqu	xmmword ptr [r9], xmm0
	ADDQ $0x10, R9                             // <--                                  // add	r9, 16
	INCQ R10                                   // <--                                  // inc	r10
	CMPQ R10, R11                              // <--                                  // cmp	r10, r11
	JAE  LBB4_8                                // <--                                  // jae	.LBB4_8
	CMPQ DX, AX                                // <--                                  // cmp	rdx, rax
	JBE  LBB4_5                                // <--                                  // jbe	.LBB4_5
	JMP  LBB4_8                                // <--                                  // jmp	.LBB4_8
...
LBB4_8:
	...
	SUBQ R8, R11             // <--                                  // sub	r11, r8
	WORD $0x8548; BYTE $0xd2 // TESTQ DX, DX                         // test	rdx, rdx
	JE   LBB4_23             // <--                                  // je	.LBB4_23
	MOVQ R11, AX             // <--                                  // mov	rax, r11
	SHRQ $0x2, AX            // <--                                  // shr	rax, 2
	WORD $0xc129             // SUBL AX, CX                          // sub	ecx, eax
	JE   LBB4_23             // <--                                  // je	.LBB4_23
	ADDQ SI, DI              // <--                                  // add	rdi, rsi
	LONG $0x32b60f41         // MOVZX 0(R10), SI                     // movzx	esi, byte ptr [r10]
	INCQ R10                 // <--                                  // inc	r10
	WORD $0x8941; BYTE $0xc8 // MOVL CX, R8                          // mov	r8d, ecx
	MOVQ R11, AX             // <--                                  // mov	rax, r11
	XORL BX, BX              // <--                                  // xor	ebx, ebx
	XORL CX, CX              // <--                                  // xor	ecx, ecx
	JMP  LBB4_13             // <--                                  // jmp	.LBB4_13

LBB4_11:
	WORD $0x8b44; BYTE $0x32       // MOVL 0(DX), R14                      // mov	r14d, dword ptr [rdx]
	LONG $0x0004bf41; WORD $0x0000 // MOVL $0x4, R15                       // mov	r15d, 4

LBB4_12:
	ADDQ R15, DX             // <--                                  // add	rdx, r15
	LONG $0x99348945         // MOVL R14, 0(R9)(BX*4)                // mov	dword ptr [r9 + 4*rbx], r14d
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	INCQ BX                  // <--                                  // inc	rbx
	ADDQ $0x4, AX            // <--                                  // add	rax, 4
	CMPL R8, BX              // <--                                  // cmp	r8d, ebx
	JE   LBB4_24             // <--                                  // je	.LBB4_24
...
LBB4_15:
	WORD $0x8941; BYTE $0xf6       // MOVL SI, R14                         // mov	r14d, esi
	WORD $0xd341; BYTE $0xee       // SHRL CL, R14                         // shr	r14d, cl
	ANDB $0x3, R14                 // <--                                  // and	r14b, 3
	LONG $0x017e8d45               // LEAL 0x1(R14), R15                   // lea	r15d, [r14 + 1]
	MOVQ DI, R12                   // <--                                  // mov	r12, rdi
	SUBQ DX, R12                   // <--                                  // sub	r12, rdx
	LONG $0xffb60f45               // MOVZX R15, R15                       // movzx	r15d, r15b
	CMPQ R12, R15                  // <--                                  // cmp	r12, r15
	JB   LBB4_25                   // <--                                  // jb	.LBB4_25
	LONG $0xf6b60f45               // MOVZX R14, R14                       // movzx	r14d, r14b
	CMPL R14, $0x1                 // <--                                  // cmp	r14d, 1
	JG   LBB4_19                   // <--                                  // jg	.LBB4_19
	WORD $0x8545; BYTE $0xf6       // TESTL R14, R14                       // test	r14d, r14d
	JNE  LBB4_21                   // <--                                  // jne	.LBB4_21
	LONG $0x32b60f44               // MOVZX 0(DX), R14                     // movzx	r14d, byte ptr [rdx]
	LONG $0x0001bf41; WORD $0x0000 // MOVL $0x1, R15                       // mov	r15d, 1
	JMP  LBB4_12                   // <--                                  // jmp	.LBB4_12

LBB4_19:
	CMPL R14, $0x2                 // <--                                  // cmp	r14d, 2
	JNE  LBB4_11                   // <--                                  // jne	.LBB4_11
	LONG $0x3ab70f44               // MOVZX 0(DX), R15                     // movzx	r15d, word ptr [rdx]
	LONG $0x72b60f44; BYTE $0x02   // MOVZX 0x2(DX), R14                   // movzx	r14d, byte ptr [rdx + 2]
	LONG $0x10e6c141               // SHLL $0x10, R14                      // shl	r14d, 16
	WORD $0x0945; BYTE $0xfe       // ORL R15, R14                         // or	r14d, r15d
	LONG $0x0003bf41; WORD $0x0000 // MOVL $0x3, R15                       // mov	r15d, 3
	JMP  LBB4_12                   // <--                                  // jmp	.LBB4_12

LBB4_21:
	LONG $0x32b70f44               // MOVZX 0(DX), R14                     // movzx	r14d, word ptr [rdx]
	LONG $0x0002bf41; WORD $0x0000 // MOVL $0x2, R15                       // mov	r15d, 2
	JMP  LBB4_12                   // <--                                  // jmp	.LBB4_12
...
TEXT ·svb_decode_u32_alt(SB), NOSPLIT, $0-48
	...
	MOVQ out+32(FP), R8
	WORD $0x8548; BYTE $0xc9 // TESTQ CX, CX                         // test	rcx, rcx
	JLE  LBB5_2              // <--                                  // jle	.LBB5_2
	LEAQ 0x3(CX), DX         // <--                                  // lea	rdx, [rcx + 3]
	SHRQ $0x2, DX            // <--                                  // shr	rdx, 2
	CMPQ DX, SI              // <--                                  // cmp	rdx, rsi
	JBE  LBB5_3              // <--                                  // jbe	.LBB5_3
...
LBB5_3:
	...
	WORD $0x2045; BYTE $0xca          // ANDL R9, R10                         // and	r10b, r9b
	CMPB R10, $0x1                    // <--                                  // cmp	r10b, 1
	JNE  LBB5_7                       // <--                                  // jne	.LBB5_7
	MOVQ CX, R11                      // <--                                  // mov	r11, rcx
	SHRQ $0x2, R11                    // <--                                  // shr	r11, 2
	ADDQ DI, R11                      // <--                                  // add	r11, rdi
	LEAQ lengthTable_0124<>(SB), BX   // <--                                  // lea	rbx, [rip + lengthTable_0124]
	LEAQ shuffleTable_0124<>(SB), R14 // <--                                  // lea	r14, [rip + shuffleTable_0124]
	MOVQ DI, R10                      // <--                                  // mov	r10, rdi
	MOVQ R8, R9                       // <--                                  // mov	r9, r8
...
LBB5_5:
	...
	CMPQ DX, AX                                // <--                                  // cmp	rdx, rax
	JBE  LBB5_5                                // <--                                  // jbe	.LBB5_5
	JMP  LBB5_8                                // <--                                  // jmp	.LBB5_8
...
LBB5_8:
	...
	XORL CX, CX                  // <--                                  // xor	ecx, ecx
	JMP  LBB5_13                 // <--                                  // jmp	.LBB5_13

LBB5_11:
	WORD $0x8b44; BYTE $0x3a // MOVL 0(DX), R15                      // mov	r15d, dword ptr [rdx]
	ADDQ $0x4, DX            // <--                                  // add	rdx, 4

LBB5_12:
	LONG $0xb13c8947         // MOVL R15, 0(R9)(R14*4)               // mov	dword ptr [r9 + 4*r14], r15d
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	INCQ R14                 // <--                                  // inc	r14
	ADDQ $0x4, AX            // <--                                  // add	rax, 4
	CMPL R8, R14             // <--                                  // cmp	r8d, r14d
	JE   LBB5_23             // <--                                  // je	.LBB5_23

LBB5_13:
	WORD $0xf980; BYTE $0x08 // CMPL CL, $0x8                        // cmp	cl, 8
	JNE  LBB5_15             // <--                                  // jne	.LBB5_15
	LONG $0x32b60f41         // MOVZX 0(R10), SI                     // movzx	esi, byte ptr [r10]
	INCQ R10                 // <--                                  // inc	r10
	XORL CX, CX              // <--                                  // xor	ecx, ecx

LBB5_15:
	WORD $0x8941; BYTE $0xf7 // MOVL SI, R15                         // mov	r15d, esi
	WORD $0xd341; BYTE $0xef // SHRL CL, R15                         // shr	r15d, cl
	ANDB $0x3, R15           // <--                                  // and	r15b, 3
	CMPB R15, $0x3           // <--                                  // cmp	r15b, 3
	LONG $0xffb60f45         // MOVZX R15, R15                       // movzx	r15d, r15b
	WORD $0x8945; BYTE $0xfc // MOVL R15, R12                        // mov	r12d, r15d
	LONG $0xe3440f44         // CMOVE BX, R12                        // cmove	r12d, ebx
	MOVQ DI, R13             // <--                                  // mov	r13, rdi
	SUBQ DX, R13             // <--                                  // sub	r13, rdx
	LONG $0xe4b60f45         // MOVZX R12, R12                       // movzx	r12d, r12b
	CMPQ R13, R12            // <--                                  // cmp	r13, r12
	JB   LBB5_24             // <--                                  // jb	.LBB5_24
	CMPL R15, $0x1           // <--                                  // cmp	r15d, 1
	JG   LBB5_19             // <--                                  // jg	.LBB5_19
	WORD $0x8545; BYTE $0xff // TESTL R15, R15                       // test	r15d, r15d
	JE   LBB5_12             // <--                                  // je	.LBB5_12
	LONG $0x3ab60f44         // MOVZX 0(DX), R15                     // movzx	r15d, byte ptr [rdx]
	INCQ DX                  // <--                                  // inc	rdx
...
TEXT ·svb_decode_s32_std(SB), NOSPLIT, $0-48
	...
	MOVQ out+32(FP), R8
	WORD $0x8548; BYTE $0xc9 // TESTQ CX, CX                         // test	rcx, rcx
	JLE  LBB6_2              // <--                                  // jle	.LBB6_2
	LEAQ 0x3(CX), DX         // <--                                  // lea	rdx, [rcx + 3]
	SHRQ $0x2, DX            // <--                                  // shr	rdx, 2
	CMPQ DX, SI              // <--                                  // cmp	rdx, rsi
	JBE  LBB6_3              // <--                                  // jbe	.LBB6_3
...
LBB6_5:
	...
	LONG $0x22b60f45                           // MOVZX 0(R10), R12                    // movzx	r12d, byte ptr [r10]
	LONG $0x14b60f41; BYTE $0x1c               // MOVZX 0(R12)(BX*1), DX               // movzx	edx, byte ptr [r12 + rbx]
	LONG $0x6f0f41f3; BYTE $0x0f               // MOVDQU 0(R15), X1                    // movdqu	xmm1, xmmword ptr [r15]
	LONG $0x04e4c141                           // SHLL $0x4, R12                       // shl	r12d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x34 // PSHUFB 0(R12)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r12 + r14]
	ADDQ R15, DX                               // <--                                  // add	rdx, r15
	...
	CMPQ DX, AX                                // <--                                  // cmp	rdx, rax
	JBE  LBB6_5                                // <--                                  // jbe	.LBB6_5
	JMP  LBB6_8                                // <--                                  // jmp	.LBB6_8
...
LBB6_12:
	ADDQ R15, DX             // <--                                  // add	rdx, r15
	WORD $0x8945; BYTE $0xf7 // MOVL R14, R15                        // mov	r15d, r14d
	WORD $0xd141; BYTE $0xef // SHRL $0x1, R15                       // shr	r15d
	LONG $0x01e68341         // ANDL $0x1, R14                       // and	r14d, 1
	WORD $0xf741; BYTE $0xde // NEGL R14                             // neg	r14d
	XORL R15, R14            // <--                                  // xor	r14d, r15d
	LONG $0x99348945         // MOVL R14, 0(R9)(BX*4)                // mov	dword ptr [r9 + 4*rbx], r14d
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	INCQ BX                  // <--                                  // inc	rbx
	ADDQ $0x4, AX            // <--                                  // add	rax, 4
	CMPL R8, BX              // <--                                  // cmp	r8d, ebx
	JE   LBB6_24             // <--                                  // je	.LBB6_24
...
LBB6_15:
	...
	LONG $0xffb60f45               // MOVZX R15, R15                       // movzx	r15d, r15b
	CMPQ R12, R15                  // <--                                  // cmp	r12, r15
	JB   LBB6_25                   // <--                                  // jb	.LBB6_25
	LONG $0xf6b60f45               // MOVZX R14, R14                       // movzx	r14d, r14b
	CMPL R14, $0x1                 // <--                                  // cmp	r14d, 1
	JG   LBB6_19                   // <--                                  // jg	.LBB6_19
	WORD $0x8545; BYTE $0xf6       // TESTL R14, R14                       // test	r14d, r14d
	JNE  LBB6_21                   // <--                                  // jne	.LBB6_21
	LONG $0x32b60f44               // MOVZX 0(DX), R14                     // movzx	r14d, byte ptr [rdx]
	LONG $0x0001bf41; WORD $0x0000 // MOVL $0x1, R15                       // mov	r15d, 1
...
TEXT ·svb_decode_s32_alt(SB), NOSPLIT, $0-48
	...
	MOVQ out+32(FP), R8
	WORD $0x8548; BYTE $0xc9 // TESTQ CX, CX                         // test	rcx, rcx
	JLE  LBB7_2              // <--                                  // jle	.LBB7_2
	LEAQ 0x3(CX), DX         // <--                                  // lea	rdx, [rcx + 3]
	SHRQ $0x2, DX            // <--                                  // shr	rdx, 2
	CMPQ DX, SI              // <--                                  // cmp	rdx, rsi
	JBE  LBB7_3              // <--                                  // jbe	.LBB7_3
...
LBB7_5:
	...
	CMPQ DX, AX                                // <--                                  // cmp	rdx, rax
	JBE  LBB7_5                                // <--                                  // jbe	.LBB7_5
	JMP  LBB7_8                                // <--                                  // jmp	.LBB7_8
...
LBB7_12:
	WORD $0x8945; BYTE $0xfc // MOVL R15, R12                        // mov	r12d, r15d
	WORD $0xd141; BYTE $0xec // SHRL $0x1, R12                       // shr	r12d
	LONG $0x01e78341         // ANDL $0x1, R15                       // and	r15d, 1
	WORD $0xf741; BYTE $0xdf // NEGL R15                             // neg	r15d
	XORL R12, R15            // <--                                  // xor	r15d, r12d
	LONG $0xb13c8947         // MOVL R15, 0(R9)(R14*4)               // mov	dword ptr [r9 + 4*r14], r15d
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	INCQ R14                 // <--                                  // inc	r14
	ADDQ $0x4, AX            // <--                                  // add	rax, 4
...
LBB12_4:
	...
	WORD $0xc089                           // MOVL AX, AX                          // mov	eax, eax
	LEAQ 0(DI)(AX*1), R11                  // <--                                  // lea	r11, [rdi + rax]
	LEAQ 0(DI)(SI*1), BX                   // <--                                  // lea	rbx, [rdi + rsi]
	SUBQ AX, SI                            // <--                                  // sub	rsi, rax
	CMPQ SI, $0x80                         // <--                                  // cmp	rsi, 128
	JB   LBB12_14                          // <--                                  // jb	.LBB12_14
	MOVQ DX, CX                            // <--                                  // mov	rcx, rdx
	SHRQ $0x2, CX                          // <--                                  // shr	rcx, 2
	QUAD $0xfffffffffff8b848; WORD $0x1fff // MOVQ $0x1ffffffffffffff8, AX         // movabs	rax, 2305843009213693944
	ANDQ CX, AX                            // <--                                  // and	rax, rcx
	LEAQ -0x80(BX), SI                     // <--                                  // lea	rsi, [rbx - 128]
	WORD $0x8548; BYTE $0xc0               // TESTQ AX, AX                         // test	rax, rax
	WORD $0x950f; BYTE $0xc1               // SETNE CL                             // setne	cl
	MOVQ SI, 0x10(SP)                      // <--                                  // mov	qword ptr [rsp + 16], rsi
	CMPQ R11, SI                           // <--                                  // cmp	r11, rsi
	LONG $0xc6960f40                       // SETBE SI                             // setbe	sil
	WORD $0x2040; BYTE $0xce               // ANDL CL, SI                          // and	sil, cl
	CMPB SI, $0x1                          // <--                                  // cmp	sil, 1
	JNE  LBB12_14                          // <--                                  // jne	.LBB12_14
	ADDQ DI, AX                            // <--                                  // add	rax, rdi
	LONG $0x6e0f4166; BYTE $0xc0           // MOVD R8, X0                          // movd	xmm0, r8d
	LONG $0xc8700f66; BYTE $0x00           // PSHUFD $0x0, X0, X1                  // pshufd	xmm1, xmm0, 0
	XORL SI, SI                            // <--                                  // xor	esi, esi
	LONG $0xc0ef0f66                       // PXOR X0, X0                          // pxor	xmm0, xmm0
	MOVQ BX, 0x8(SP)                       // <--                                  // mov	qword ptr [rsp + 8], rbx
	LEAQ lengthTable_1234<>(SB), R14       // <--                                  // lea	r14, [rip + lengthTable_1234]
	LEAQ shuffleTable_1234<>(SB), R10      // <--                                  // lea	r10, [rip + shuffleTable_1234]

LBB12_7:
	MOVQ 0(DI), CX                             // <--                                  // mov	rcx, qword ptr [rdi]
	LONG $0xc9700f66; BYTE $0xff               // PSHUFD $0xff, X1, X1                 // pshufd	xmm1, xmm1, 255
	WORD $0x8548; BYTE $0xc9                   // TESTQ CX, CX                         // test	rcx, rcx
	JE   LBB12_9                               // <--                                  // je	.LBB12_9
	LONG $0xf9b60f44                           // MOVZX CL, R15                        // movzx	r15d, cl
	LONG $0x2cb60f47; BYTE $0x37               // MOVZX 0(R15)(R14*1), R13             // movzx	r13d, byte ptr [r15 + r14]
	LONG $0x6f0f41f3; BYTE $0x13               // MOVDQU 0(R11), X2                    // movdqu	xmm2, xmmword ptr [r11]
	LONG $0x04e7c141                           // SHLL $0x4, R15                       // shl	r15d, 4
	LONG $0x380f4366; WORD $0x1400; BYTE $0x17 // PSHUFB 0(R15)(R10*1), X2             // pshufb	xmm2, xmmword ptr [r15 + r10]
	LEAQ 0(R11)(R13*1), R12                    // <--                                  // lea	r12, [r11 + r13]
	...
	LONG $0x7f0f41f3; WORD $0x311c             // MOVDQU X3, 0(R9)(SI*1)               // movdqu	xmmword ptr [r9 + rsi], xmm3
	MOVQ AX, BX                                // <--                                  // mov	rbx, rax
	WORD $0xb60f; BYTE $0xc5                   // MOVZX CH, AX                         // movzx	eax, ch
	LONG $0x3cb60f46; BYTE $0x30               // MOVZX 0(AX)(R14*1), R15              // movzx	r15d, byte ptr [rax + r14]
	LONG $0x6f0f43f3; WORD $0x2b0c             // MOVDQU 0(R11)(R13*1), X1             // movdqu	xmm1, xmmword ptr [r11 + r13]
	WORD $0xe0c1; BYTE $0x04                   // SHLL $0x4, AX                        // shl	eax, 4
	LONG $0x380f4266; WORD $0x0c00; BYTE $0x10 // PSHUFB 0(AX)(R10*1), X1              // pshufb	xmm1, xmmword ptr [rax + r10]
	LEAQ 0(R12)(R15*1), R11                    // <--                                  // lea	r11, [r12 + r15]
	LONG $0xd16f0f66                           // MOVDQA X1, X2                        // movdqa	xmm2, xmm1
	...
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x10 // MOVDQU X2, 0x10(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 16], xmm2
	...
	LONG $0x2cb60f46; BYTE $0x30               // MOVZX 0(AX)(R14*1), R13              // movzx	r13d, byte ptr [rax + r14]
	...
	LONG $0x7f0f41f3; WORD $0x314c; BYTE $0x20 // MOVDQU X1, 0x20(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 32], xmm1
	WORD $0xc889                               // MOVL CX, AX                          // mov	eax, ecx
	WORD $0xe8c1; BYTE $0x18                   // SHRL $0x18, AX                       // shr	eax, 24
	LONG $0x3cb60f46; BYTE $0x30               // MOVZX 0(AX)(R14*1), R15              // movzx	r15d, byte ptr [rax + r14]
	LONG $0x6f0f43f3; WORD $0x1d54; BYTE $0x00 // MOVDQU 0(R13)(R11*1), X2             // movdqu	xmm2, xmmword ptr [r13 + r11]
	WORD $0xe0c1; BYTE $0x04                   // SHLL $0x4, AX                        // shl	eax, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x10 // PSHUFB 0(AX)(R10*1), X2              // pshufb	xmm2, xmmword ptr [rax + r10]
	LEAQ 0(R11)(R13*1), AX                     // <--                                  // lea	rax, [r11 + r13]
	LEAQ 0(AX)(R15*1), R11                     // <--                                  // lea	r11, [rax + r15]
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xc9700f66; BYTE $0xff               // PSHUFD $0xff, X1, X1                 // pshufd	xmm1, xmm1, 255
	LONG $0xdafe0f66                           // PADDD X2, X3                         // paddd	xmm3, xmm2
	...
	LONG $0xd3fe0f66                           // PADDD X3, X2                         // paddd	xmm2, xmm3
	LONG $0xd1fe0f66                           // PADDD X1, X2                         // paddd	xmm2, xmm1
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x30 // MOVDQU X2, 0x30(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 48], xmm2
	MOVQ CX, R12                               // <--                                  // mov	r12, rcx
	SHRQ $0x20, R12                            // <--                                  // shr	r12, 32
	LONG $0xecb60f45                           // MOVZX R12, R13                       // movzx	r13d, r12b
	LONG $0x64b60f47; WORD $0x0035             // MOVZX 0(R13)(R14*1), R12             // movzx	r12d, byte ptr [r13 + r14]
	LONG $0x6f0f41f3; WORD $0x070c             // MOVDQU 0(R15)(AX*1), X1              // movdqu	xmm1, xmmword ptr [r15 + rax]
	LONG $0x04e5c141                           // SHLL $0x4, R13                       // shl	r13d, 4
	QUAD $0x00154c00380f4366                   // PSHUFB 0(R13)(R10*1), X1             // pshufb	xmm1, xmmword ptr [r13 + r10]
	LONG $0xd96f0f66                           // MOVDQA X1, X3                        // movdqa	xmm3, xmm1
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xd2700f66; BYTE $0xff               // PSHUFD $0xff, X2, X2                 // pshufd	xmm2, xmm2, 255
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	...
	LONG $0xcbfe0f66                           // PADDD X3, X1                         // paddd	xmm1, xmm3
	LONG $0xcafe0f66                           // PADDD X2, X1                         // paddd	xmm1, xmm2
	LONG $0x7f0f41f3; WORD $0x314c; BYTE $0x40 // MOVDQU X1, 0x40(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 64], xmm1
	MOVQ CX, AX                                // <--                                  // mov	rax, rcx
	SHRQ $0x28, AX                             // <--                                  // shr	rax, 40
	WORD $0xb60f; BYTE $0xc0                   // MOVZX AL, AX                         // movzx	eax, al
	LONG $0x3cb60f46; BYTE $0x30               // MOVZX 0(AX)(R14*1), R15              // movzx	r15d, byte ptr [rax + r14]
	LONG $0x6f0f43f3; WORD $0x1c14             // MOVDQU 0(R12)(R11*1), X2             // movdqu	xmm2, xmmword ptr [r12 + r11]
	WORD $0xe0c1; BYTE $0x04                   // SHLL $0x4, AX                        // shl	eax, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x10 // PSHUFB 0(AX)(R10*1), X2              // pshufb	xmm2, xmmword ptr [rax + r10]
	LEAQ 0(R11)(R12*1), AX                     // <--                                  // lea	rax, [r11 + r12]
	...
	LONG $0xd3fe0f66                           // PADDD X3, X2                         // paddd	xmm2, xmm3
	LONG $0xd1fe0f66                           // PADDD X1, X2                         // paddd	xmm2, xmm1
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x50 // MOVDQU X2, 0x50(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 80], xmm2
	MOVQ CX, R11                               // <--                                  // mov	r11, rcx
	SHRQ $0x30, R11                            // <--                                  // shr	r11, 48
	LONG $0xdbb60f45                           // MOVZX R11, R11                       // movzx	r11d, r11b
	LONG $0x2cb60f47; BYTE $0x33               // MOVZX 0(R11)(R14*1), R13             // movzx	r13d, byte ptr [r11 + r14]
	LONG $0x6f0f41f3; WORD $0x070c             // MOVDQU 0(R15)(AX*1), X1              // movdqu	xmm1, xmmword ptr [r15 + rax]
	MOVQ BX, AX                                // <--                                  // mov	rax, rbx
	MOVQ 0x8(SP), BX                           // <--                                  // mov	rbx, qword ptr [rsp + 8]
	LONG $0x04e3c141                           // SHLL $0x4, R11                       // shl	r11d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x13 // PSHUFB 0(R11)(R10*1), X1             // pshufb	xmm1, xmmword ptr [r11 + r10]
	LONG $0xd96f0f66                           // MOVDQA X1, X3                        // movdqa	xmm3, xmm1
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xd2700f66; BYTE $0xff               // PSHUFD $0xff, X2, X2                 // pshufd	xmm2, xmm2, 255
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	...
	LONG $0xcbfe0f66                           // PADDD X3, X1                         // paddd	xmm1, xmm3
	LONG $0xcafe0f66                           // PADDD X2, X1                         // paddd	xmm1, xmm2
	LONG $0x7f0f41f3; WORD $0x314c; BYTE $0x60 // MOVDQU X1, 0x60(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 96], xmm1
	SHRQ $0x38, CX                             // <--                                  // shr	rcx, 56
	LONG $0x1cb60f46; BYTE $0x31               // MOVZX 0(CX)(R14*1), R11              // movzx	r11d, byte ptr [rcx + r14]
	...
	LONG $0x380f4266; WORD $0x1400; BYTE $0x11 // PSHUFB 0(CX)(R10*1), X2              // pshufb	xmm2, xmmword ptr [rcx + r10]
	ADDQ R13, R11                              // <--                                  // add	r11, r13
	...
	JMP  LBB12_10                              // <--                                  // jmp	.LBB12_10

LBB12_9:
	LONG $0xf00f41f2; BYTE $0x13               // LDDQU 0(R11), X2                     // lddqu	xmm2, xmmword ptr [r11]
	...
	LONG $0xd1fe0f66                           // PADDD X1, X2                         // paddd	xmm2, xmm1
	LONG $0x7f0f41f3; WORD $0x310c             // MOVDQU X1, 0(R9)(SI*1)               // movdqu	xmmword ptr [r9 + rsi], xmm1
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x10 // MOVDQU X2, 0x10(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 16], xmm2
	LONG $0xf00f41f2; WORD $0x084b             // LDDQU 0x8(R11), X1                   // lddqu	xmm1, xmmword ptr [r11 + 8]
	...
	LONG $0xcbfe0f66                           // PADDD X3, X1                         // paddd	xmm1, xmm3
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x20 // MOVDQU X3, 0x20(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 32], xmm3
	LONG $0x7f0f41f3; WORD $0x314c; BYTE $0x30 // MOVDQU X1, 0x30(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 48], xmm1
	LONG $0xf00f41f2; WORD $0x1053             // LDDQU 0x10(R11), X2                  // lddqu	xmm2, xmmword ptr [r11 + 16]
	LONG $0x30380f66; BYTE $0xd2               // PMOVZXBW X2, X2                      // pmovzxbw	xmm2, xmm2
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x02               // PSLLDQ $0x2, X3                      // pslldq	xmm3, 2
	LONG $0xc9700f66; BYTE $0xff               // PSHUFD $0xff, X1, X1                 // pshufd	xmm1, xmm1, 255
	...
	LONG $0xd0690f66                           // PUNPCKHWD X0, X2                     // punpckhwd	xmm2, xmm0
	LONG $0xd3fe0f66                           // PADDD X3, X2                         // paddd	xmm2, xmm3
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x40 // MOVDQU X3, 0x40(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 64], xmm3
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x50 // MOVDQU X2, 0x50(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 80], xmm2
	LONG $0xf00f41f2; WORD $0x184b             // LDDQU 0x18(R11), X1                  // lddqu	xmm1, xmmword ptr [r11 + 24]
	LONG $0x30380f66; BYTE $0xc9               // PMOVZXBW X1, X1                      // pmovzxbw	xmm1, xmm1
	LONG $0xd96f0f66                           // MOVDQA X1, X3                        // movdqa	xmm3, xmm1
	LONG $0xfb730f66; BYTE $0x02               // PSLLDQ $0x2, X3                      // pslldq	xmm3, 2
	LONG $0xd2700f66; BYTE $0xff               // PSHUFD $0xff, X2, X2                 // pshufd	xmm2, xmm2, 255
	...
	LONG $0xc8690f66                           // PUNPCKHWD X0, X1                     // punpckhwd	xmm1, xmm0
	LONG $0xcbfe0f66                           // PADDD X3, X1                         // paddd	xmm1, xmm3
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x60 // MOVDQU X3, 0x60(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 96], xmm3
	ADDQ $0x20, R11                            // <--                                  // add	r11, 32

LBB12_10:
	LONG $0x7f0f41f3; WORD $0x314c; BYTE $0x70 // MOVDQU X1, 0x70(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 112], xmm1
	ADDQ $0x8, DI                              // <--                                  // add	rdi, 8
	SUBQ $-0x80, SI                            // <--                                  // sub	rsi, -128
	CMPQ DI, AX                                // <--                                  // cmp	rdi, rax
	JAE  LBB12_12                              // <--                                  // jae	.LBB12_12
	CMPQ R11, 0x10(SP)                         // <--                                  // cmp	r11, qword ptr [rsp + 16]
	JBE  LBB12_7                               // <--                                  // jbe	.LBB12_7

LBB12_12:
	LONG $0x163a0f66; WORD $0x03c8 // PEXTRD $0x3, X1, AX                  // pextrd	eax, xmm1, 3
	LEAQ 0(R9)(SI*1), R10          // <--                                  // lea	r10, [r9 + rsi]
	SARQ $0x2, SI                  // <--                                  // sar	rsi, 2
	CMPQ R10, R9                   // <--                                  // cmp	r10, r9
	LONG $0xc0460f41               // CMOVBE R8, AX                        // cmovbe	eax, r8d
	SUBQ SI, DX                    // <--                                  // sub	rdx, rsi
	LONG $0xc04f0f44               // CMOVG AX, R8                         // cmovg	r8d, eax
	WORD $0xd285                   // TESTL DX, DX                         // test	edx, edx
	JNE  LBB12_15                  // <--                                  // jne	.LBB12_15
	JMP  LBB12_28                  // <--                                  // jmp	.LBB12_28

LBB12_14:
	MOVQ R9, R10  // <--                                  // mov	r10, r9
	WORD $0xd285  // TESTL DX, DX                         // test	edx, edx
	JE   LBB12_28 // <--                                  // je	.LBB12_28

LBB12_15:
	WORD $0x854d; BYTE $0xdb // TESTQ R11, R11                       // test	r11, r11
	JE   LBB12_28            // <--                                  // je	.LBB12_28
	WORD $0xb60f; BYTE $0x37 // MOVZX 0(DI), SI                      // movzx	esi, byte ptr [rdi]
	INCQ DI                  // <--                                  // inc	rdi
	MOVQ R10, AX             // <--                                  // mov	rax, r10
	XORL CX, CX              // <--                                  // xor	ecx, ecx
	JMP  LBB12_19            // <--                                  // jmp	.LBB12_19

LBB12_17:
	LONG $0x3bb70f45               // MOVZX 0(R11), R15                    // movzx	r15d, word ptr [r11]
	LONG $0x73b60f45; BYTE $0x02   // MOVZX 0x2(R11), R14                  // movzx	r14d, byte ptr [r11 + 2]
	LONG $0x10e6c141               // SHLL $0x10, R14                      // shl	r14d, 16
	WORD $0x0945; BYTE $0xfe       // ORL R15, R14                         // or	r14d, r15d
	LONG $0x0003bf41; WORD $0x0000 // MOVL $0x3, R15                       // mov	r15d, 3

LBB12_18:
	WORD $0x0145; BYTE $0xf0 // ADDL R14, R8                         // add	r8d, r14d
	ADDQ R15, R11            // <--                                  // add	r11, r15
	WORD $0x8944; BYTE $0x00 // MOVL R8, 0(AX)                       // mov	dword ptr [rax], r8d
	ADDQ $0x4, AX            // <--                                  // add	rax, 4
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	WORD $0xcaff             // DECL DX                              // dec	edx
	JE   LBB12_29            // <--                                  // je	.LBB12_29

LBB12_19:
	WORD $0xf980; BYTE $0x08 // CMPL CL, $0x8                        // cmp	cl, 8
	JNE  LBB12_21            // <--                                  // jne	.LBB12_21
	WORD $0xb60f; BYTE $0x37 // MOVZX 0(DI), SI                      // movzx	esi, byte ptr [rdi]
	INCQ DI                  // <--                                  // inc	rdi
	XORL CX, CX              // <--                                  // xor	ecx, ecx
...
LBB12_21:
	...
	LONG $0xffb60f45               // MOVZX R15, R15                       // movzx	r15d, r15b
	CMPQ R12, R15                  // <--                                  // cmp	r12, r15
	JB   LBB12_30                  // <--                                  // jb	.LBB12_30
	LONG $0xf6b60f45               // MOVZX R14, R14                       // movzx	r14d, r14b
	CMPL R14, $0x1                 // <--                                  // cmp	r14d, 1
	JG   LBB12_25                  // <--                                  // jg	.LBB12_25
	WORD $0x8545; BYTE $0xf6       // TESTL R14, R14                       // test	r14d, r14d
	JNE  LBB12_27                  // <--                                  // jne	.LBB12_27
	LONG $0x33b60f45               // MOVZX 0(R11), R14                    // movzx	r14d, byte ptr [r11]
	LONG $0x0001bf41; WORD $0x0000 // MOVL $0x1, R15                       // mov	r15d, 1
	JMP  LBB12_18                  // <--                                  // jmp	.LBB12_18

LBB12_25:
	CMPL R14, $0x2                 // <--                                  // cmp	r14d, 2
	JE   LBB12_17                  // <--                                  // je	.LBB12_17
	WORD $0x8b45; BYTE $0x33       // MOVL 0(R11), R14                     // mov	r14d, dword ptr [r11]
	LONG $0x0004bf41; WORD $0x0000 // MOVL $0x4, R15                       // mov	r15d, 4
	JMP  LBB12_18                  // <--                                  // jmp	.LBB12_18

LBB12_27:
	LONG $0x33b70f45               // MOVZX 0(R11), R14                    // movzx	r14d, word ptr [r11]
	LONG $0x0002bf41; WORD $0x0000 // MOVL $0x2, R15                       // mov	r15d, 2
	JMP  LBB12_18                  // <--                                  // jmp	.LBB12_18
...
LBB12_29:
	...
	SARQ $0x2, AX            // <--                                  // sar	rax, 2
	WORD $0x854d; BYTE $0xdb // TESTQ R11, R11                       // test	r11, r11
	LONG $0xc3440f49         // CMOVE R11, AX                        // cmove	rax, r11
	NOP                      // (skipped)                            // lea	rsp, [rbp - 40]
	NOP                      // (skipped)                            // pop	rbx
	NOP                      // (skipped)                            // pop	r12
	NOP                      // (skipped)                            // pop	r13
...
LBB13_4:
	...
	SUBQ AX, SI                            // <--                                  // sub	rsi, rax
	CMPQ SI, $0x80                         // <--                                  // cmp	rsi, 128
	JB   LBB13_14                          // <--                                  // jb	.LBB13_14
	MOVQ DX, CX                            // <--                                  // mov	rcx, rdx
	SHRQ $0x2, CX                          // <--                                  // shr	rcx, 2
	QUAD $0xfffffffffff8b848; WORD $0x1fff // MOVQ $0x1ffffffffffffff8, AX         // movabs	rax, 2305843009213693944
	ANDQ CX, AX                            // <--                                  // and	rax, rcx
	MOVQ 0x8(SP), CX                       // <--                                  // mov	rcx, qword ptr [rsp + 8]
	LEAQ -0x80(CX), R15                    // <--                                  // lea	r15, [rcx - 128]
	WORD $0x8548; BYTE $0xc0               // TESTQ AX, AX                         // test	rax, rax
	WORD $0x950f; BYTE $0xc1               // SETNE CL                             // setne	cl
	CMPQ R11, R15                          // <--                                  // cmp	r11, r15
	LONG $0xc6960f40                       // SETBE SI                             // setbe	sil
	WORD $0x2040; BYTE $0xce               // ANDL CL, SI                          // and	sil, cl
	CMPB SI, $0x1                          // <--                                  // cmp	sil, 1
	JNE  LBB13_14                          // <--                                  // jne	.LBB13_14
	ADDQ DI, AX                            // <--                                  // add	rax, rdi
	LONG $0x6e0f4166; BYTE $0xc0           // MOVD R8, X0                          // movd	xmm0, r8d
	LONG $0xc8700f66; BYTE $0x00           // PSHUFD $0x0, X0, X1                  // pshufd	xmm1, xmm0, 0
	XORL SI, SI                            // <--                                  // xor	esi, esi
	QUAD $0x555555555555b948; WORD $0x5555 // MOVQ $0x5555555555555555, CX         // movabs	rcx, 6148914691236517205
	LONG $0xc0ef0f66                       // PXOR X0, X0                          // pxor	xmm0, xmm0
...
LBB13_7:
	...
	LONG $0xc9700f66; BYTE $0xff               // PSHUFD $0xff, X1, X1                 // pshufd	xmm1, xmm1, 255
	CMPQ BX, CX                                // <--                                  // cmp	rbx, rcx
	JNE  LBB13_9                               // <--                                  // jne	.LBB13_9
	LONG $0xf00f41f2; BYTE $0x13               // LDDQU 0(R11), X2                     // lddqu	xmm2, xmmword ptr [r11]
	LONG $0x30380f66; BYTE $0xd2               // PMOVZXBW X2, X2                      // pmovzxbw	xmm2, xmm2
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x02               // PSLLDQ $0x2, X3                      // pslldq	xmm3, 2
	...
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x60 // MOVDQU X3, 0x60(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 96], xmm3
	ADDQ $0x20, R11                            // <--                                  // add	r11, 32
	JMP  LBB13_10                              // <--                                  // jmp	.LBB13_10

LBB13_9:
	WORD $0xb60f; BYTE $0xcb                   // MOVZX BL, CX                         // movzx	ecx, bl
	LONG $0x24b60f46; BYTE $0x11               // MOVZX 0(CX)(R10*1), R12              // movzx	r12d, byte ptr [rcx + r10]
	LONG $0x6f0f41f3; BYTE $0x13               // MOVDQU 0(R11), X2                    // movdqu	xmm2, xmmword ptr [r11]
	WORD $0xe1c1; BYTE $0x04                   // SHLL $0x4, CX                        // shl	ecx, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x31 // PSHUFB 0(CX)(R14*1), X2              // pshufb	xmm2, xmmword ptr [rcx + r14]
	LEAQ 0(R11)(R12*1), R13                    // <--                                  // lea	r13, [r11 + r12]
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xdafe0f66                           // PADDD X2, X3                         // paddd	xmm3, xmm2
	LONG $0xcbfe0f66                           // PADDD X3, X1                         // paddd	xmm1, xmm3
	...
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	LONG $0x7f0f41f3; WORD $0x311c             // MOVDQU X3, 0(R9)(SI*1)               // movdqu	xmmword ptr [r9 + rsi], xmm3
	WORD $0xb60f; BYTE $0xcf                   // MOVZX BH, CX                         // movzx	ecx, bh
	MOVQ AX, R15                               // <--                                  // mov	r15, rax
	LONG $0x04b60f42; BYTE $0x11               // MOVZX 0(CX)(R10*1), AX               // movzx	eax, byte ptr [rcx + r10]
	LONG $0x6f0f43f3; WORD $0x230c             // MOVDQU 0(R11)(R12*1), X1             // movdqu	xmm1, xmmword ptr [r11 + r12]
	WORD $0xe1c1; BYTE $0x04                   // SHLL $0x4, CX                        // shl	ecx, 4
	LONG $0x380f4266; WORD $0x0c00; BYTE $0x31 // PSHUFB 0(CX)(R14*1), X1              // pshufb	xmm1, xmmword ptr [rcx + r14]
	LEAQ 0(AX)(R13*1), R11                     // <--                                  // lea	r11, [rax + r13]
	LONG $0xd16f0f66                           // MOVDQA X1, X2                        // movdqa	xmm2, xmm1
	LONG $0xfa730f66; BYTE $0x04               // PSLLDQ $0x4, X2                      // pslldq	xmm2, 4
	LONG $0xdb700f66; BYTE $0xff               // PSHUFD $0xff, X3, X3                 // pshufd	xmm3, xmm3, 255
	LONG $0xd1fe0f66                           // PADDD X1, X2                         // paddd	xmm2, xmm1
	...
	LONG $0xd3fe0f66                           // PADDD X3, X2                         // paddd	xmm2, xmm3
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x10 // MOVDQU X2, 0x10(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 16], xmm2
	WORD $0xd989                               // MOVL BX, CX                          // mov	ecx, ebx
	WORD $0xe9c1; BYTE $0x10                   // SHRL $0x10, CX                       // shr	ecx, 16
	WORD $0xb60f; BYTE $0xc9                   // MOVZX CL, CX                         // movzx	ecx, cl
	LONG $0x24b60f46; BYTE $0x11               // MOVZX 0(CX)(R10*1), R12              // movzx	r12d, byte ptr [rcx + r10]
	LONG $0x6f0f42f3; WORD $0x280c             // MOVDQU 0(AX)(R13*1), X1              // movdqu	xmm1, xmmword ptr [rax + r13]
	WORD $0xe1c1; BYTE $0x04                   // SHLL $0x4, CX                        // shl	ecx, 4
	LONG $0x380f4266; WORD $0x0c00; BYTE $0x31 // PSHUFB 0(CX)(R14*1), X1              // pshufb	xmm1, xmmword ptr [rcx + r14]
	LONG $0xd96f0f66                           // MOVDQA X1, X3                        // movdqa	xmm3, xmm1
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	...
	WORD $0xd889                               // MOVL BX, AX                          // mov	eax, ebx
	WORD $0xe8c1; BYTE $0x18                   // SHRL $0x18, AX                       // shr	eax, 24
	LONG $0x0cb60f42; BYTE $0x10               // MOVZX 0(AX)(R10*1), CX               // movzx	ecx, byte ptr [rax + r10]
	LONG $0x6f0f43f3; WORD $0x1c14             // MOVDQU 0(R12)(R11*1), X2             // movdqu	xmm2, xmmword ptr [r12 + r11]
	WORD $0xe0c1; BYTE $0x04                   // SHLL $0x4, AX                        // shl	eax, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x30 // PSHUFB 0(AX)(R14*1), X2              // pshufb	xmm2, xmmword ptr [rax + r14]
	LEAQ 0(R11)(R12*1), AX                     // <--                                  // lea	rax, [r11 + r12]
	LEAQ 0(AX)(CX*1), R11                      // <--                                  // lea	r11, [rax + rcx]
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xc9700f66; BYTE $0xff               // PSHUFD $0xff, X1, X1                 // pshufd	xmm1, xmm1, 255
	LONG $0xdafe0f66                           // PADDD X2, X3                         // paddd	xmm3, xmm2
	...
	LONG $0x0c6f0ff3; BYTE $0x01               // MOVDQU 0(CX)(AX*1), X1               // movdqu	xmm1, xmmword ptr [rcx + rax]
	LONG $0x04e4c141                           // SHLL $0x4, R12                       // shl	r12d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x34 // PSHUFB 0(R12)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r12 + r14]
	LONG $0xd96f0f66                           // MOVDQA X1, X3                        // movdqa	xmm3, xmm1
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	...
	LONG $0x380f4266; WORD $0x1400; BYTE $0x30 // PSHUFB 0(AX)(R14*1), X2              // pshufb	xmm2, xmmword ptr [rax + r14]
	LEAQ 0(R11)(R13*1), AX                     // <--                                  // lea	rax, [r11 + r13]
	LEAQ 0(AX)(CX*1), R13                      // <--                                  // lea	r13, [rax + rcx]
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xc9700f66; BYTE $0xff               // PSHUFD $0xff, X1, X1                 // pshufd	xmm1, xmm1, 255
	LONG $0xdafe0f66                           // PADDD X2, X3                         // paddd	xmm3, xmm2
	...
	LONG $0xd1fe0f66                           // PADDD X1, X2                         // paddd	xmm2, xmm1
	LONG $0x7f0f41f3; WORD $0x3154; BYTE $0x50 // MOVDQU X2, 0x50(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 80], xmm2
	MOVQ BX, R11                               // <--                                  // mov	r11, rbx
	SHRQ $0x30, R11                            // <--                                  // shr	r11, 48
	LONG $0xdbb60f45                           // MOVZX R11, R11                       // movzx	r11d, r11b
	LONG $0x24b60f47; BYTE $0x13               // MOVZX 0(R11)(R10*1), R12             // movzx	r12d, byte ptr [r11 + r10]
	LONG $0x0c6f0ff3; BYTE $0x01               // MOVDQU 0(CX)(AX*1), X1               // movdqu	xmm1, xmmword ptr [rcx + rax]
	QUAD $0x555555555555b948; WORD $0x5555     // MOVQ $0x5555555555555555, CX         // movabs	rcx, 6148914691236517205
	MOVQ R15, AX                               // <--                                  // mov	rax, r15
	MOVQ 0x10(SP), R15                         // <--                                  // mov	r15, qword ptr [rsp + 16]
	LONG $0x04e3c141                           // SHLL $0x4, R11                       // shl	r11d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x33 // PSHUFB 0(R11)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r11 + r14]
	LONG $0xd96f0f66                           // MOVDQA X1, X3                        // movdqa	xmm3, xmm1
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
	LONG $0xd2700f66; BYTE $0xff               // PSHUFD $0xff, X2, X2                 // pshufd	xmm2, xmm2, 255
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	...
	WORD $0xe3c1; BYTE $0x04                   // SHLL $0x4, BX                        // shl	ebx, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x33 // PSHUFB 0(BX)(R14*1), X2              // pshufb	xmm2, xmmword ptr [rbx + r14]
	ADDQ R12, R11                              // <--                                  // add	r11, r12
	ADDQ R13, R11                              // <--                                  // add	r11, r13
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xfb730f66; BYTE $0x04               // PSLLDQ $0x4, X3                      // pslldq	xmm3, 4
...
LBB13_10:
	...
	SUBQ $-0x80, SI                            // <--                                  // sub	rsi, -128
	CMPQ DI, AX                                // <--                                  // cmp	rdi, rax
	JAE  LBB13_12                              // <--                                  // jae	.LBB13_12
	CMPQ R11, R15                              // <--                                  // cmp	r11, r15
	JBE  LBB13_7                               // <--                                  // jbe	.LBB13_7

LBB13_12:
	LONG $0x163a0f66; WORD $0x03c8 // PEXTRD $0x3, X1, AX                  // pextrd	eax, xmm1, 3
	LEAQ 0(R9)(SI*1), BX           // <--                                  // lea	rbx, [r9 + rsi]
	SARQ $0x2, SI                  // <--                                  // sar	rsi, 2
	CMPQ BX, R9                    // <--                                  // cmp	rbx, r9
	LONG $0xc0460f41               // CMOVBE R8, AX                        // cmovbe	eax, r8d
	SUBQ SI, DX                    // <--                                  // sub	rdx, rsi
	LONG $0xc04f0f44               // CMOVG AX, R8                         // cmovg	r8d, eax
	WORD $0xd285                   // TESTL DX, DX                         // test	edx, edx
	JNE  LBB13_15                  // <--                                  // jne	.LBB13_15
	JMP  LBB13_27                  // <--                                  // jmp	.LBB13_27

LBB13_14:
	MOVQ R9, BX   // <--                                  // mov	rbx, r9
	WORD $0xd285  // TESTL DX, DX                         // test	edx, edx
	JE   LBB13_27 // <--                                  // je	.LBB13_27
...
LBB13_15:
	...
	WORD $0xb60f; BYTE $0x37       // MOVZX 0(DI), SI                      // movzx	esi, byte ptr [rdi]
	INCQ DI                        // <--                                  // inc	rdi
	LONG $0x0004be41; WORD $0x0000 // MOVL $0x4, R14                       // mov	r14d, 4
	MOVQ BX, AX                    // <--                                  // mov	rax, rbx
	XORL CX, CX                    // <--                                  // xor	ecx, ecx
...
LBB13_18:
	WORD $0x0145; BYTE $0xf8 // ADDL R15, R8                         // add	r8d, r15d
	WORD $0x8944; BYTE $0x00 // MOVL R8, 0(AX)                       // mov	dword ptr [rax], r8d
	ADDQ $0x4, AX            // <--                                  // add	rax, 4
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	WORD $0xcaff             // DECL DX                              // dec	edx
	JE   LBB13_28            // <--                                  // je	.LBB13_28
...
LBB13_21:
	...
	LONG $0xffb60f45         // MOVZX R15, R15                       // movzx	r15d, r15b
	WORD $0x8945; BYTE $0xfc // MOVL R15, R12                        // mov	r12d, r15d
	LONG $0xe6440f45         // CMOVE R14, R12                       // cmove	r12d, r14d
	MOVQ 0x8(SP), R13        // <--                                  // mov	r13, qword ptr [rsp + 8]
	SUBQ R11, R13            // <--                                  // sub	r13, r11
	LONG $0xe4b60f45         // MOVZX R12, R12                       // movzx	r12d, r12b
	CMPQ R13, R12            // <--                                  // cmp	r13, r12
	JB   LBB13_29            // <--                                  // jb	.LBB13_29
	CMPL R15, $0x1           // <--                                  // cmp	r15d, 1
	JG   LBB13_25            // <--                                  // jg	.LBB13_25
	WORD $0x8545; BYTE $0xff // TESTL R15, R15                       // test	r15d, r15d
	JE   LBB13_18            // <--                                  // je	.LBB13_18
	LONG $0x3bb60f45         // MOVZX 0(R11), R15                    // movzx	r15d, byte ptr [r11]
	INCQ R11                 // <--                                  // inc	r11
...
LBB13_25:
	...
	WORD $0x8b45; BYTE $0x3b // MOVL 0(R11), R15                     // mov	r15d, dword ptr [r11]
...
TEXT ·svb_delta_decode_s32_std(SB), 0, $24-56
	MOVQ    in+0(FP), DI
	MOVQ    in_len+8(FP), SI
	MOVQ    in_cap+16(FP), DX
	MOVQ    count+24(FP), CX
...
LBB14_4:
	...
	WORD     $0xc089                           // MOVL AX, AX                          // mov	eax, eax
	LEAQ     0(DI)(AX*1), R11                  // <--                                  // lea	r11, [rdi + rax]
	LEAQ     0(DI)(SI*1), R13                  // <--                                  // lea	r13, [rdi + rsi]
	SUBQ     AX, SI                            // <--                                  // sub	rsi, rax
	CMPQ     SI, $0x80                         // <--                                  // cmp	rsi, 128
	JB       LBB14_11                          // <--                                  // jb	.LBB14_11
	MOVQ     DX, AX                            // <--                                  // mov	rax, rdx
	SHRQ     $0x2, AX                          // <--                                  // shr	rax, 2
	QUAD     $0xfffffffffff8ba49; WORD $0x1fff // MOVQ $0x1ffffffffffffff8, R10        // movabs	r10, 2305843009213693944
	ANDQ     AX, R10                           // <--                                  // and	r10, rax
	LEAQ     -0x80(R13), CX                    // <--                                  // lea	rcx, [r13 - 128]
	WORD     $0x854d; BYTE $0xd2               // TESTQ R10, R10                       // test	r10, r10
	WORD     $0x950f; BYTE $0xc0               // SETNE AL                             // setne	al
	MOVQ     CX, 0x10(SP)                      // <--                                  // mov	qword ptr [rsp + 16], rcx
	CMPQ     R11, CX                           // <--                                  // cmp	r11, rcx
	WORD     $0x960f; BYTE $0xc1               // SETBE CL                             // setbe	cl
	WORD     $0xc120                           // ANDL AL, CL                          // and	cl, al
	WORD     $0xf980; BYTE $0x01               // CMPL CL, $0x1                        // cmp	cl, 1
	JNE      LBB14_11                          // <--                                  // jne	.LBB14_11
	MOVQ     R13, 0x8(SP)                      // <--                                  // mov	qword ptr [rsp + 8], r13
...
LBB14_7:
	...
	LONG $0x24b60f44; BYTE $0x18               // MOVZX 0(AX)(BX*1), R12               // movzx	r12d, byte ptr [rax + rbx]
	LONG $0x6f0f41f3; BYTE $0x13               // MOVDQU 0(R11), X2                    // movdqu	xmm2, xmmword ptr [r11]
	WORD $0xe0c1; BYTE $0x04                   // SHLL $0x4, AX                        // shl	eax, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x30 // PSHUFB 0(AX)(R14*1), X2              // pshufb	xmm2, xmmword ptr [rax + r14]
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	...
	LONG $0xd1700f66; BYTE $0xff               // PSHUFD $0xff, X1, X2                 // pshufd	xmm2, xmm1, 255
	...
	LONG $0x7f0f41f3; WORD $0x310c             // MOVDQU X1, 0(R9)(SI*1)               // movdqu	xmmword ptr [r9 + rsi], xmm1
	WORD $0xb60f; BYTE $0xc5                   // MOVZX CH, AX                         // movzx	eax, ch
	LONG $0x3cb60f44; BYTE $0x18               // MOVZX 0(AX)(BX*1), R15               // movzx	r15d, byte ptr [rax + rbx]
	LONG $0x6f0f43f3; WORD $0x2314             // MOVDQU 0(R11)(R12*1), X2             // movdqu	xmm2, xmmword ptr [r11 + r12]
	WORD $0xe0c1; BYTE $0x04                   // SHLL $0x4, AX                        // shl	eax, 4
	LONG $0x380f4266; WORD $0x1400; BYTE $0x30 // PSHUFB 0(AX)(R14*1), X2              // pshufb	xmm2, xmmword ptr [rax + r14]
	LEAQ 0(R11)(R12*1), AX                     // <--                                  // lea	rax, [r11 + r12]
	LEAQ 0(AX)(R15*1), R11                     // <--                                  // lea	r11, [rax + r15]
	...
	LONG $0xf9730f66; BYTE $0x08               // PSLLDQ $0x8, X1                      // pslldq	xmm1, 8
	LONG $0xcafe0f66                           // PADDD X2, X1                         // paddd	xmm1, xmm2
	LONG $0x7f0f41f3; WORD $0x314c; BYTE $0x10 // MOVDQU X1, 0x10(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 16], xmm1
	WORD $0x8941; BYTE $0xcc                   // MOVL CX, R12                         // mov	r12d, ecx
	LONG $0x10ecc141                           // SHRL $0x10, R12                      // shr	r12d, 16
	LONG $0xe4b60f45                           // MOVZX R12, R12                       // movzx	r12d, r12b
	LONG $0x2cb60f45; BYTE $0x1c               // MOVZX 0(R12)(BX*1), R13              // movzx	r13d, byte ptr [r12 + rbx]
	LONG $0x6f0f41f3; WORD $0x0714             // MOVDQU 0(R15)(AX*1), X2              // movdqu	xmm2, xmmword ptr [r15 + rax]
	LONG $0x04e4c141                           // SHLL $0x4, R12                       // shl	r12d, 4
	LONG $0x380f4366; WORD $0x1400; BYTE $0x34 // PSHUFB 0(R12)(R14*1), X2             // pshufb	xmm2, xmmword ptr [r12 + r14]
	LEAQ 0(R11)(R13*1), R12                    // <--                                  // lea	r12, [r11 + r13]
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	LONG $0xd3720f66; BYTE $0x01               // PSRLD $0x1, X3                       // psrld	xmm3, 1
	LONG $0xd0db0f66                           // PAND X0, X2                          // pand	xmm2, xmm0
	...
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x20 // MOVDQU X3, 0x20(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 32], xmm3
	WORD $0x8941; BYTE $0xcf                   // MOVL CX, R15                         // mov	r15d, ecx
	LONG $0x18efc141                           // SHRL $0x18, R15                      // shr	r15d, 24
	LONG $0x04b60f41; BYTE $0x1f               // MOVZX 0(R15)(BX*1), AX               // movzx	eax, byte ptr [r15 + rbx]
	LONG $0x6f0f43f3; WORD $0x1d4c; BYTE $0x00 // MOVDQU 0(R13)(R11*1), X1             // movdqu	xmm1, xmmword ptr [r13 + r11]
	LONG $0x04e7c141                           // SHLL $0x4, R15                       // shl	r15d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x37 // PSHUFB 0(R15)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r15 + r14]
	LEAQ 0(R12)(AX*1), R11                     // <--                                  // lea	r11, [r12 + rax]
	LONG $0xd16f0f66                           // MOVDQA X1, X2                        // movdqa	xmm2, xmm1
	LONG $0xd2720f66; BYTE $0x01               // PSRLD $0x1, X2                       // psrld	xmm2, 1
	LONG $0xc8db0f66                           // PAND X0, X1                          // pand	xmm1, xmm0
	LONG $0xe4ef0f66                           // PXOR X4, X4                          // pxor	xmm4, xmm4
	...
	LONG $0xcb700f66; BYTE $0xff               // PSHUFD $0xff, X3, X1                 // pshufd	xmm1, xmm3, 255
	LONG $0xd46f0f66                           // MOVDQA X4, X2                        // movdqa	xmm2, xmm4
	LONG $0xfa730f66; BYTE $0x04               // PSLLDQ $0x4, X2                      // pslldq	xmm2, 4
	LONG $0xd4fe0f66                           // PADDD X4, X2                         // paddd	xmm2, xmm4
	LONG $0xda6f0f66                           // MOVDQA X2, X3                        // movdqa	xmm3, xmm2
	...
	LONG $0xdafe0f66                           // PADDD X2, X3                         // paddd	xmm3, xmm2
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x30 // MOVDQU X3, 0x30(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 48], xmm3
	MOVQ CX, R15                               // <--                                  // mov	r15, rcx
	SHRQ $0x20, R15                            // <--                                  // shr	r15, 32
	LONG $0xefb60f45                           // MOVZX R15, R13                       // movzx	r13d, r15b
	LONG $0x7cb60f45; WORD $0x001d             // MOVZX 0(R13)(BX*1), R15              // movzx	r15d, byte ptr [r13 + rbx]
	LONG $0x6f0f42f3; WORD $0x200c             // MOVDQU 0(AX)(R12*1), X1              // movdqu	xmm1, xmmword ptr [rax + r12]
	LONG $0x04e5c141                           // SHLL $0x4, R13                       // shl	r13d, 4
	QUAD $0x00354c00380f4366                   // PSHUFB 0(R13)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r13 + r14]
	...
	MOVQ CX, AX                                // <--                                  // mov	rax, rcx
	SHRQ $0x28, AX                             // <--                                  // shr	rax, 40
	LONG $0xe0b60f44                           // MOVZX AL, R12                        // movzx	r12d, al
	LONG $0x04b60f41; BYTE $0x1c               // MOVZX 0(R12)(BX*1), AX               // movzx	eax, byte ptr [r12 + rbx]
	LONG $0x6f0f43f3; WORD $0x1f0c             // MOVDQU 0(R15)(R11*1), X1             // movdqu	xmm1, xmmword ptr [r15 + r11]
	LONG $0x04e4c141                           // SHLL $0x4, R12                       // shl	r12d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x34 // PSHUFB 0(R12)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r12 + r14]
	LEAQ 0(AX)(R13*1), R12                     // <--                                  // lea	r12, [rax + r13]
	LONG $0xd16f0f66                           // MOVDQA X1, X2                        // movdqa	xmm2, xmm1
	LONG $0xd2720f66; BYTE $0x01               // PSRLD $0x1, X2                       // psrld	xmm2, 1
	LONG $0xc8db0f66                           // PAND X0, X1                          // pand	xmm1, xmm0
	LONG $0xe4ef0f66                           // PXOR X4, X4                          // pxor	xmm4, xmm4
	...
	LONG $0xdafe0f66                           // PADDD X2, X3                         // paddd	xmm3, xmm2
	LONG $0xd9fe0f66                           // PADDD X1, X3                         // paddd	xmm3, xmm1
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x50 // MOVDQU X3, 0x50(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 80], xmm3
	MOVQ CX, R11                               // <--                                  // mov	r11, rcx
	SHRQ $0x30, R11                            // <--                                  // shr	r11, 48
	LONG $0xdbb60f45                           // MOVZX R11, R11                       // movzx	r11d, r11b
	LONG $0x3cb60f45; BYTE $0x1b               // MOVZX 0(R11)(BX*1), R15              // movzx	r15d, byte ptr [r11 + rbx]
	LONG $0x6f0f42f3; WORD $0x280c             // MOVDQU 0(AX)(R13*1), X1              // movdqu	xmm1, xmmword ptr [rax + r13]
	LONG $0x04e3c141                           // SHLL $0x4, R11                       // shl	r11d, 4
	LONG $0x380f4366; WORD $0x0c00; BYTE $0x33 // PSHUFB 0(R11)(R14*1), X1             // pshufb	xmm1, xmmword ptr [r11 + r14]
	LONG $0xd16f0f66                           // MOVDQA X1, X2                        // movdqa	xmm2, xmm1
	...
	LONG $0x7f0f41f3; WORD $0x315c; BYTE $0x60 // MOVDQU X3, 0x60(R9)(SI*1)            // movdqu	xmmword ptr [r9 + rsi + 96], xmm3
	SHRQ $0x38, CX                             // <--                                  // shr	rcx, 56
	LONG $0x1cb60f44; BYTE $0x19               // MOVZX 0(CX)(BX*1), R11               // movzx	r11d, byte ptr [rcx + rbx]
	LONG $0x6f0f43f3; WORD $0x270c             // MOVDQU 0(R15)(R12*1), X1             // movdqu	xmm1, xmmword ptr [r15 + r12]
	WORD $0xe1c1; BYTE $0x04                   // SHLL $0x4, CX                        // shl	ecx, 4
	LONG $0x380f4266; WORD $0x0c00; BYTE $0x31 // PSHUFB 0(CX)(R14*1), X1              // pshufb	xmm1, xmmword ptr [rcx + r14]
	ADDQ R15, R11                              // <--                                  // add	r11, r15
	...
	ADDQ $0x8, DI                              // <--                                  // add	rdi, 8
	SUBQ $-0x80, SI                            // <--                                  // sub	rsi, -128
	CMPQ DI, R10                               // <--                                  // cmp	rdi, r10
	JAE  LBB14_9                               // <--                                  // jae	.LBB14_9
	CMPQ R11, 0x10(SP)                         // <--                                  // cmp	r11, qword ptr [rsp + 16]
...
LBB14_9:
	...
	MOVQ 0x8(SP), R13              // <--                                  // mov	r13, qword ptr [rsp + 8]
	WORD $0xd285                   // TESTL DX, DX                         // test	edx, edx
	JNE  LBB14_12                  // <--                                  // jne	.LBB14_12
	JMP  LBB14_25                  // <--                                  // jmp	.LBB14_25

LBB14_11:
	MOVQ R9, BX   // <--                                  // mov	rbx, r9
	WORD $0xd285  // TESTL DX, DX                         // test	edx, edx
	JE   LBB14_25 // <--                                  // je	.LBB14_25
...
LBB14_15:
	...
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	WORD $0xcaff             // DECL DX                              // dec	edx
	JE   LBB14_26            // <--                                  // je	.LBB14_26

LBB14_16:
	WORD $0xf980; BYTE $0x08 // CMPL CL, $0x8                        // cmp	cl, 8
	JNE  LBB14_18            // <--                                  // jne	.LBB14_18
	WORD $0xb60f; BYTE $0x37 // MOVZX 0(DI), SI                      // movzx	esi, byte ptr [rdi]
	INCQ DI                  // <--                                  // inc	rdi
	XORL CX, CX              // <--                                  // xor	ecx, ecx
...
LBB14_18:
	...
	LONG $0xffb60f45               // MOVZX R15, R15                       // movzx	r15d, r15b
	CMPQ R12, R15                  // <--                                  // cmp	r12, r15
	JB   LBB14_27                  // <--                                  // jb	.LBB14_27
	LONG $0xf6b60f45               // MOVZX R14, R14                       // movzx	r14d, r14b
	CMPL R14, $0x1                 // <--                                  // cmp	r14d, 1
	JG   LBB14_22                  // <--                                  // jg	.LBB14_22
	WORD $0x8545; BYTE $0xf6       // TESTL R14, R14                       // test	r14d, r14d
	JNE  LBB14_24                  // <--                                  // jne	.LBB14_24
	LONG $0x33b60f45               // MOVZX 0(R11), R14                    // movzx	r14d, byte ptr [r11]
	LONG $0x0001bf41; WORD $0x0000 // MOVL $0x1, R15                       // mov	r15d, 1
...
LBB15_4:
	...
	SUBQ     AX, SI                            // <--                                  // sub	rsi, rax
	CMPQ     SI, $0x80                         // <--                                  // cmp	rsi, 128
	JB       LBB15_11                          // <--                                  // jb	.LBB15_11
	MOVQ     DX, AX                            // <--                                  // mov	rax, rdx
	SHRQ     $0x2, AX                          // <--                                  // shr	rax, 2
	QUAD     $0xfffffffffff8ba49; WORD $0x1fff // MOVQ $0x1ffffffffffffff8, R10        // movabs	r10, 2305843009213693944
	ANDQ     AX, R10                           // <--                                  // and	r10, rax
	MOVQ     0x8(SP), AX                       // <--                                  // mov	rax, qword ptr [rsp + 8]
	LEAQ     -0x80(AX), CX                     // <--                                  // lea	rcx, [rax - 128]
	WORD     $0x854d; BYTE $0xd2               // TESTQ R10, R10                       // test	r10, r10
	WORD     $0x950f; BYTE $0xc0               // SETNE AL                             // setne	al
	MOVQ     CX, 0x10(SP)                      // <--                                  // mov	qword ptr [rsp + 16], rcx
	CMPQ     R11, CX                           // <--                                  // cmp	r11, rcx
...
LBB15_9:
	...
	LONG $0xc04f0f44               // CMOVG AX, R8                         // cmovg	r8d, eax
	WORD $0xd285                   // TESTL DX, DX                         // test	edx, edx
	MOVQ 0x8(SP), R10              // <--                                  // mov	r10, qword ptr [rsp + 8]
	JNE  LBB15_12                  // <--                                  // jne	.LBB15_12
	JMP  LBB15_24                  // <--                                  // jmp	.LBB15_24

LBB15_11:
	MOVQ R9, BX       // <--                                  // mov	rbx, r9
	WORD $0xd285      // TESTL DX, DX                         // test	edx, edx
	MOVQ 0x8(SP), R10 // <--                                  // mov	r10, qword ptr [rsp + 8]
	JE   LBB15_24     // <--                                  // je	.LBB15_24
...
LBB15_15:
	...
	WORD $0xc180; BYTE $0x02 // ADDL $0x2, CL                        // add	cl, 2
	WORD $0xcaff             // DECL DX                              // dec	edx
	JE   LBB15_25            // <--                                  // je	.LBB15_25

LBB15_16:
	WORD $0xf980; BYTE $0x08 // CMPL CL, $0x8                        // cmp	cl, 8
	JNE  LBB15_18            // <--                                  // jne	.LBB15_18
	WORD $0xb60f; BYTE $0x37 // MOVZX 0(DI), SI                      // movzx	esi, byte ptr [rdi]
	INCQ DI                  // <--                                  // inc	rdi
	XORL CX, CX              // <--                                  // xor	ecx, ecx
...
LBB15_18:
	...
	WORD $0x8945; BYTE $0xfc // MOVL R15, R12                        // mov	r12d, r15d
	LONG $0xe6440f45         // CMOVE R14, R12                       // cmove	r12d, r14d
	MOVQ R10, R13            // <--                                  // mov	r13, r10
	SUBQ R11, R13            // <--                                  // sub	r13, r11
	LONG $0xe4b60f45         // MOVZX R12, R12                       // movzx	r12d, r12b
	CMPQ R13, R12            // <--                                  // cmp	r13, r12
	JB   LBB15_26            // <--                                  // jb	.LBB15_26
	CMPL R15, $0x1           // <--                                  // cmp	r15d, 1
	JG   LBB15_22            // <--                                  // jg	.LBB15_22
	WORD $0x8545; BYTE $0xff // TESTL R15, R15                       // test	r15d, r15d
	JE   LBB15_15            // <--                                  // je	.LBB15_15
	LONG $0x3bb60f45         // MOVZX 0(R11), R15                    // movzx	r15d, byte ptr [r11]
	INCQ R11                 // <--                                  // inc	r11
